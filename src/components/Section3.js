...
const Section3 = () => {
  return (
    <Section3Container>
      ...
      <Paragraph>
        <List>
          <ListItem>Auditório para palestras</ListItem>
          <ListItem>Refeitório com banheiro</ListItem>
          <ListItem>Dormitórios com banheiro</ListItem>
          <ListItem>Cozinha</ListItem>
          <ListItem>Espaço para Esporte/Lazer</ListItem>
          <ListItem>Piscina</ListItem>
          <ListItem>Escritório</ListItem>
          <ListItem>Horticultura</ListItem>
          <ListItem>Criação de aves</ListItem>
          <ListItem>Cozinha para cursos de panificação</ListItem>
          <ListItem>Sala para cursos profissionalizantes</ListItem>
        </List>
      </Paragraph>
    </Section3Container>
  );
